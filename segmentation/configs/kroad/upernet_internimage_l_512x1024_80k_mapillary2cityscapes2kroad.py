...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/kroad.py',		# 수정
...
model = dict(
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        init_cfg=None),
    decode_head=dict(num_classes=24, in_channels=[160, 320, 640, 1280]),	# num_classes 수정
    auxiliary_head=dict(num_classes=24, in_channels=640),					# num_classes 수정
