...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/kroad.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=24, in_channels=[112, 224, 448, 896]),
    auxiliary_head=dict(num_classes=24, in_channels=448),
...
load_from = 'checkpoints/upernet_internimage_b_512x1024_160k_cityscapes.pth'